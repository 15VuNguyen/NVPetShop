<%-- 
    ...
    Created on : Mar 14, 2024, 1:26:44 AM
    Author     : acer
--%>
    ...
    <div class="container">
      ...
      <div class="main-body">
        ...
        <form action="mainController" method="post" style="display: flex; gap: 10px; max-width: 400px; ">
            ...
            <input class="action_btn_copy" type="submit" value="Search" />
        </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${acc.id != accountItem.id}">
                                            ...
                                            <input class="action_btn" type='submit' value='block/unblock' name="action" onclick="return window.confirm('are u sure?')" >
                                            <input class="action_btn" type='submit' value='View-Customer' name="action" >
                                        </c:if>
                                    </td>
                                </tr>
                            </tbody>
