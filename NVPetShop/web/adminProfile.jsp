<%-- 
    ...
    Created on : Mar 20, 2024, 8:33:01 AM
    Author     : acer
--%>
...
<html>
    ...
    <title>Admin Profile | Where Every Paw Matters</title>
        ...
        <div class="containerClass">
            ...
            <nav>
                <div class="side_navbar">
                    ...
                    <a href="mainController?action=adminProfile" class="active">Profile</a>
            ...
            <div class="main-body">
                ...
                <c:if test="${acc != null}">
                    <jsp:useBean id="a" class="dao.AdminDAO" scope="request">
                        <c:set var="admin" value="${a.getAdminByID(acc.id)}"/>
                        <div class="container rounded bg-white mt-5 mb-5">
                            <div class="row">
                                <div class="col-md-3 border-right">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        <img class="rounded-circle mt-5" width="150px" src="./img/userImgExample.jpg">
                                        <span class="font-weight-bold">${acc.username}</span>
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="${admin.getFirstName()}" readonly="">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="labels">Last Name</label>
                                                <input type="text" class="form-control" value="${admin.getLastName()}" readonly="">
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                <label class="labels">Phone Number</label>
                                                <input type="text" class="form-control" value="${admin.getPhoneNumber()}" readonly="">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="labels">Address</label>
                                                <input type="text" class="form-control" value="${admin.getAddress()}" readonly="">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="labels">Country</label>
                                                <input type="text" class="form-control" value="${admin.getCountry()}" readonly="">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="labels">Birthday</label>
                                                <input type="text" class="form-control" value="${admin.getBirthday()}" readonly="">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="labels">AccountID</label>
                                                <input type="text" class="form-control" value="${admin.getAccID()}" readonly="">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="labels">Email</label>
                                                <input type="text" class="form-control" value="${acc.email}" readonly="">
                                            </div>
                                        </div>  
                                    </div>
                                </div>
