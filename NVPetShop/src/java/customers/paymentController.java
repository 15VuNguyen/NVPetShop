...
public class paymentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            int petid = (Integer) session.getAttribute("petid");
            if (acc != null) {
                float totalmoney = Float.parseFloat(request.getParameter("txttotal"));
                HashMap<Service, Integer> giohang = (HashMap<Service, Integer>) session.getAttribute("cart");
                OrderDAO d = new OrderDAO();
                int result = d.insertOrder(cusid, totalmoney, giohang, petid, 0);
                if (result > 0) {
